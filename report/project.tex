...
Sports predicting is mainly used by bookmakers, in order to offer fair bets, that do 
...
\cite{Joseph_2006} compared expert constructed Bayesian networks' ability to predict football 
...
Article \cite{Constantinou_2013} from 2013 explores 

\section{Experiment description}
\subsection{Tools}
\subsection{Data for experiment}
